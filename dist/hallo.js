...
(function() {
  (function(jQuery) {
    return jQuery.widget("IKS.hallojustify", {
      ...
      populateToolbar: function(toolbar) {
        var buttonize, buttonset, enabled, justify, widget, _ref,
          _this = this;
        widget = this;
        buttonset = jQuery("<span class=\"" + widget.widgetName + "\"></span>");
        buttonize = function(justify) {
          var buttonHolder;
          buttonHolder = jQuery('<span></span>');
          buttonHolder.hallobutton({
            label: justify,
        ...
        _ref = this.options.justifies;
        for (justify in _ref) {
          enabled = _ref[justify];
          if (!enabled) {
            continue;
          }
          buttonize(justify);
  ...
  (function(jQuery) {
    return jQuery.widget("IKS.hallolists", {
      ...
      populateToolbar: function(toolbar) {
        ...
        if (this.options.lists.ordered && this.options.lists.unordered) {
          buttonize("Ordered", "ordered list", "glyphicon-list-ol");
        }
        if (this.options.lists.ordered && !this.options.lists.unordered) {
          buttonize("Ordered", "list", "glyphicon-list");
        }
        if (this.options.lists.unordered && this.options.lists.ordered) {
          buttonize("Unordered", "unordered list", "glyphicon-list-ul");
        }
        if (this.options.lists.unordered && !this.options.lists.ordered) {
          buttonize("Unordered", "list", "glyphicon-list");
        }
        buttonset.hallobuttonset();
        return toolbar.append(buttonset);
      }
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonize = function(cmd, label) {
          ...
          buttonElement.hallobutton({
            ...
            editable: _this.options.editable,
            label: label,
            icon: cmd === 'undo' ? 'glyphicon-undo' : 'glyphicon-repeat',
            command: cmd,
            queryState: false,
            cssClass: _this.options.buttonCssClass
          });
